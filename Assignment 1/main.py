...
for N in N_values:
    ...
    # ax1.plot(x1_data, y1_data, 'o', markersize=4, label=f"data N={N}")

    # Overlay on f2 axes
    ax2.plot(x2_fine, p2_fine, '--', label=f"N={N}")
    # ax2.plot(x2_data, y2_data, 'o', markersize=4, label=f"data N={N}")
...
fig1.savefig("Plots/f1_interpolation_N=100.png", dpi=300, bbox_inches="tight")
fig2.savefig("Plots/f2_interpolation_N=100.png", dpi=300, bbox_inches="tight")
plt.show()
